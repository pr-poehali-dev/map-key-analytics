    ...
    items: [
      {
        ...
        icon: "AlertTriangle",
        title: "Ограничение",
        text: "Для реализации планирования по конкретным сотрудникам требуется загрузка персональных данных, что вступает в конфликт с позицией Заказчика по защите ПДН и исключает возможность реализации требований ТЗ по планированию штатного персонала.",
      },
      {
        type: "decision",
        icon: "CheckCircle",
        title: "Принятое решение",
        text: "Отказаться от загрузки персональных данных (ФИО) штатных сотрудников из 1С:ЗУП в 1С:УХ из-за требований законодательства о защите персональных данных и рисков утечки информации.",
      },
    ],
  },
  {
    ...
    items: [
      {
        type: "cancelled",
        icon: "XCircle",
        title: "Пересмотр решения от 11.03",
        text: "1. Отказ от планирования по ФИО. Использование обезличенных данных (например, только должности) или нового справочника без ФИО.",
      },
      {
        type: "risk",
        icon: "AlertTriangle",
        title: "Ограничение",
        text: "Открытый вопрос по способу хранения и использования персональных данных сотрудников в базе УХ.",
      },
    ],
  },
  {
    ...
    items: [
      {
        type: "risk",
        icon: "AlertOctagon",
        title: "Не обсуждалось",
        text: "Обсуждение не проводилось. См. Ограничение встречи от 16.03.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: "CheckCircle",
        title: "Принятое решение",
        text: "Получен ответ от СБ на разрешение ограниченного использования (ФИО + должность) с получением согласия на обработку персональных данных. Процедура получения согласия организуется на стороне Заказчика.",
      },
      {
        type: "risk",
        icon: "AlertTriangle",
        title: "Ограничение",
        text: "Не обсуждались варианты мест хранения и ведения данных по собственным сотрудникам.",
      },
    ],
  },
  {
...
export default function PersonnelStaffRoadmap() {
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "18px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
              ...
              <span style={{ fontSize: "8px", color: "#9ca3af" }}>16.03 — решение 11.03 пересмотрено: отказ от ФИО, переход на обезличенные данные</span>
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
              <Icon name="ShieldCheck" size={10} style={{ color: "#7aab8a" }} />
              <span style={{ fontSize: "8px", color: "#9ca3af" }}>19.03 — СБ разрешил ФИО+должность при наличии согласия на обработку ПДН</span>
            </div>
          </div>
          <span style={{ fontSize: "8px", color: "#d1d5db", letterSpacing: "0.06em" }}>
            Март 2026 · Ключевая аналитика — Персонал планирования (Штат)
          </span>
        </div>
      </div>
    </div>
